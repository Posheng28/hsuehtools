...
export async function loadLegal(code: string): Promise<Record<string, [number, number]> | null> {
...
export async function saveLegal(code: string, weeks: Record<string, [number, number]>): Promise<void> {
  mem.set(code, weeks)
